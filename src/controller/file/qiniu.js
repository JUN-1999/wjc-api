const { log } = require('icqq/lib/common.js');
...
module.exports = class extends Base {
  async uploadIMGAction() {
    ...
    const date = new Date();
    const key = date.getFullYear() + '_' + (date.getMonth() + 1) + '_' + date.getDate() + '_' + date.getHours() + date.getMinutes() + date.getSeconds() + date.getMilliseconds() + '.' + file.name.split('.')[1];
